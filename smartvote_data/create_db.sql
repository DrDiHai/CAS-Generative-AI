...
excel_file = 'smartvote_data\\23_ch_nr_candidates_de_2024_03_06.xlsx'  # Name of the Excel file (replace with yer file's name)
sheet_name = '23_ch_nr_candidates_de_2024_03_'  # Name of the sheet within yer file, if any.
...
conn = sqlite3.connect('nationalrat.db')
cursor = conn.cursor()
...
table_name = 'Kandidat'  # The name of yer table
